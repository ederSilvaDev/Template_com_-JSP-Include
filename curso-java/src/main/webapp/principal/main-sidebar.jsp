		...
		<ul class="sidebar-menu">
			...
			<li class="active treeview"><a class="waves-effect waves-dark"
				href="<%=request.getContextPath()%>/principal/principal.jsp">
					<i class="icon-speedometer"></i><span>Painel</span>
			</a></li>
			<li class="nav-level">Componentes</li>
			<li class="treeview"><a class="waves-effect waves-dark"
				href="#!"><i class="icon-briefcase"></i><span> Cadastros</span><i
					class="icon-arrow-down"></i></a>
				<ul class="treeview-menu">
					<li><a class="waves-effect waves-dark"
						href="<%=request.getContextPath()%>/principal/usuario.jsp"><i
			...
			<li class="treeview"><a class="waves-effect waves-dark"
				href="#!"><i class="icon-chart"></i><span> Relatórios</span><span
					class="label label-success menu-caption">New</span><i
					class="icon-arrow-down"></i></a>
				<ul class="treeview-menu">
